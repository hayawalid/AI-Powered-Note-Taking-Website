...
<body>
  <div class="sound-recorder-wrapper">
    ...
    <button id="stop-recognition" class="color" disabled>Pause</button>
    <button id="save-content" class="color">Start Over</button>
    <button id="save-content" class="color">Save & Transcribe</button>
  </div>
